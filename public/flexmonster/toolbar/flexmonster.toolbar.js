/** 
 * Flexmonster Pivot Table & Charts v2.7.5 [https://www.flexmonster.com/]
...
FlexmonsterToolbar.prototype.getTabs = function () {
    ...
    // Connect tab
    tabs.push({
        title: Labels.connect, id: "fm-tab-connect", icon: this.icons.connect, kibana: false,
        menu: [
            ...
            { title: this.osUtils.isMobile ? Labels.connect_remote_csv_mobile : Labels.connect_remote_csv, id: "fm-tab-connect-remote-csv", handler: this.connectRemoteCSV, icon: this.icons.connect_csv_remote },
            { title: this.osUtils.isMobile ? Labels.connect_remote_json_mobile : Labels.connect_remote_json, id: "fm-tab-connect-remote-json", handler: this.connectRemoteJSON, icon: this.icons.connect_json_remote },
            ...
            { title: this.osUtils.isMobile ? Labels.connect_elastic_mobile : Labels.connect_elastic, id: "fm-tab-connect-elastic", handler: this.connectElastic, flat: false, icon: this.icons.connect_elastic }
        ]
    });

    // Open tab
    tabs.push({
        title: Labels.open, id: "fm-tab-open", icon: this.icons.open, kibana: false,
        menu: [
    ...
    // Save tab
    tabs.push({ title: Labels.save, id: "fm-tab-save", handler: this.saveHandler, mobile: false, kibana: false, icon: this.icons.save });
    ...
    tabs.push({
        ...
        menu: [
            ...
            { title: Labels.export_csv, id: "fm-tab-export-csv", handler: this.exportHandler, args: "csv", icon: this.icons.export_csv },
    ...
    tabs.push({
        ...
        menu: [
            { title: Labels.charts_column, id: "fm-tab-charts-column", handler: this.chartsHandler, args: "column", icon: this.icons.charts },
            ...
            { title: Labels.charts_stacked_column, id: "fm-tab-charts-stacked-column", handler: this.chartsHandler, args: "stacked_column", flat: false, icon: this.icons.charts_stacked_column },
            { title: Labels.charts_column_line, id: "fm-tab-charts-column-line", handler: this.chartsHandler, args: "column_line", icon: this.icons.charts_column_line },
...
FlexmonsterToolbar.prototype.showConnectToElasticDialog = function () {
    ...
    var onConnectBtnClick = function () {
        ...
        self.pivot.getElasticIndices({ host: hostUrlInput.value }, indicesHandler);
    };
...
FlexmonsterToolbar.prototype.showFormatCellsDialog = function () {
    ...
    var applyHandler = function () {
        ...
        if (currentReport.hasOwnProperty("formats") && currentReport.formats.length > 0) {
            formatVO = currentReport.formats.find(function (elem) { 
                return elem.name == currentFormatVO.name;
            });
        }
        if (formatVO == null) {
            formatVO = {};
    ...
    function initializeSelect(select, config) {
        ...
        for (var key in config) {
            select.options[i] = new Option(key, config[key]);
            i++;
        }
    }
...
FlexmonsterToolbar.prototype.filterConnectMenu = function () {
    ...
    if (this.dataSourceType == 1 || this.dataSourceType == 2) {
        ...
        menu.push({ title: this.osUtils.isMobile ? Labels.connect_elastic_mobile : Labels.connect_elastic, id: "fm-tab-connect-elastic", handler: this.connectElastic, flat: false, icon: this.icons.connect_elastic });
    }
